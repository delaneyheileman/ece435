...
p1 = Provider('Colgan', 'PED',
              [['SDO', 'SDO'], ['CHCF', 'CHCF'], ['SDO', 'SDO'], ['SDO', 'SDO'], ['CHCF', 'Adm'], ['CHCF', 'Adm'],
               ['SDO', 'SDO']], 40)

p2 = Provider('Jones', 'PED',
              [['SDO', 'SDO'], ['SDO', 'SDO'], ['CHCF', 'CHCF'], ['Adm', 'CHCF'], ['PPHC', 'PPHC'], ['CHCF', 'CHCF'],
               ['SDO', 'SDO']], 40)
...
p7 = Provider('Veal', 'FP',
              [['SDO', 'SDO'], ['PPHC', 'PPHC'], ['SDO', 'SDO'], ['PPHC', 'PPHC'], ['PPHC', 'PPHC'], ['Adm', 'Adm'],
               ['SDO', 'SDO']], 40)
...
p11 = Provider('Stochosky', 'FP',
               [['SDO', 'SDO'], ['SDO', 'SDO'], ['PPHC', 'PPHC'], ['SDO', 'SDO'], ['SDO', 'SDO'], ['PPHC', 'PPHC'],
                ['SDO', 'SDO']], 40)
